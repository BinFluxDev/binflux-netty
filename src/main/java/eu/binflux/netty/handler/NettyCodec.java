...
public class NettyCodec extends ByteToMessageCodec<Object> {
    ...
    protected void encode(ChannelHandlerContext ctx, Object object, ByteBuf out) {
        try {
            ...
            endpoint.eventHandler().handleEvent(new ErrorEvent(new CodecException("Error while encoding..", e)));
        }
    }
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
        try {
            ...
            endpoint.eventHandler().handleEvent(new ErrorEvent(new CodecException("Error while decoding..", e)));
        }
    }
