...
import eu.binflux.netty.serialization.serializer.ElsaSerialization;
...
public class ElsaSerializationTest {
    ...
    public static void setupClass() {
        ...
        BUILDER = EndpointBuilder.newBuilder()
                .eventExecutor(5)
                .serializer(new PooledSerializer(ElsaSerialization.class));
