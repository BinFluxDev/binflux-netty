...
import eu.binflux.netty.serialization.serializer.QuickserSerializer;
...
public class QuickserSerializerTest {
    ...
    public static void setupClass() {
        ...
        BUILDER = EndpointBuilder.newBuilder()
                .eventExecutor(5)
                .serializer(new PooledSerializer(QuickserSerializer.class));
