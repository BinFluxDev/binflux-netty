...
import eu.binflux.serial.kryo.KryoSerialization;
...
public class KryoSerializationTest {
    ...
    public static void setupClass() {
        System.out.println("== Test KryoSerializer Behaviour == ");

        BUILDER = EndpointBuilder.newBuilder()
                .eventExecutor(5)
                .serializer(new SerializerPool(KryoSerialization.class));
    ...
    public static void afterClass() {
        ...
        System.out.println("== Finished KryoSerializer Behaviour == ");
    }
