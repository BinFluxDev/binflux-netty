...
import eu.binflux.serializer.serialization.KryoUnsafeSerialization;
...
public class KryoUnsafeSerializationTest {
    ...
    public static void setupClass() {
        System.out.println("== Test KryoUnsafeSerializer Behaviour == ");

        BUILDER = EndpointBuilder.newBuilder()
                .eventExecutor(5)
                .serializer(new SerializerPool(KryoUnsafeSerialization.class));
    ...
    public static void afterClass() {
        ...
        System.out.println("== Finished KryoUnsafeSerializer Behaviour == ");
    }
