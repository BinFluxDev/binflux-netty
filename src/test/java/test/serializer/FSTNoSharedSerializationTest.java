...
import eu.binflux.netty.serialization.serializer.FSTNoSharedSerialization;
...
public class FSTNoSharedSerializationTest {
    ...
    public static void setupClass() {
        ...
        BUILDER = EndpointBuilder.newBuilder()
                .eventExecutor(5)
                .serializer(new PooledSerializer(FSTNoSharedSerialization.class));
